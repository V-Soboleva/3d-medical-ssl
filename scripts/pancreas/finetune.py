...
from medical_ssl_3d.nn import UNet3d_v2, ConvBlock3d
...
class SupervisedUNet3d(pl.LightningModule):
    def __init__(self, pretrained_unet_path=None, residual=False):
        ...
        if pretrained_unet_path is not None:
            self.backbone.encoder.load_state_dict(torch.load(pretrained_unet_path))
...
if __name__ == '__main__':
    p = '/homes/vsoboleva/3d-medical-ssl/scripts/pancreas/tb_logs_new/pretrain_jigsaw/version_0/backbone.pt'
